package com.jinpika.temp.generator.generator;
...
public class MyBatisPlusGenerator {
    ...
    private static PackageConfig initPackageConfig(String projectPath, String moduleName) {
        ...
        return new PackageConfig.Builder()
                ...
                .entity("model")
                .pathInfo(Collections.singletonMap(OutputFile.mapperXml, projectPath + outputDir + "/src/main/resources/mapper/" + moduleName))
                .build();
    }
