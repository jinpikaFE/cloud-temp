package com.jinpika.temp.product.generator;
...
public class MyBatisPlusGenerator {
    ...
    private static GlobalConfig initGlobalConfig(String projectPath) {
        return new GlobalConfig.Builder()
                .outputDir(projectPath + "/temp-product" + "/src/main/java")
                .author("macro")
                .disableOpenDir()
                .enableSwagger()
                .fileOverride()
    ...
    private static PackageConfig initPackageConfig(String projectPath, String moduleName) {
        ...
        return new PackageConfig.Builder()
                ...
                .entity("model")
                .pathInfo(Collections.singletonMap(OutputFile.mapperXml, projectPath + "/temp-product" + "/src/main/resources/mapper/" + moduleName))
                .build();
    }
