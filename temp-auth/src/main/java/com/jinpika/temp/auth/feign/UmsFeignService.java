package com.jinpika.temp.auth.feign;
...
public interface UmsFeignService {
    // 远程服务的url
    @RequestMapping("/ums/admin/loadByUsername")
//注意写全优惠券类上还有映射//注意我们这个地方不是控制层，所以这个请求映射请求的不是我们服务器上的东西，而是nacos注册中心的
    UserDto loadUserByUsername(@RequestParam String username);//得到一个R对象
